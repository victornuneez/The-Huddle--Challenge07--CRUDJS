...
Este proyecto es una aplicación web dinámica construida con **Node.js** y **Express**, que implementa un **CRUD completo** para la gestión y votación de temas de aprendizaje. La arquitectura sigue estrictamente el patrón **Modelo-Vista-Controlador (MVC)** y utiliza **PostgreSQL** como motor de base de datos persistente. El propósito del proyecto es demostrar el dominio en la estructuración de aplicaciones escalables, separando las responsabilidades de cada componente para facilitar el **mantenimiento** y el **trabajo en equipo**.
...
- **controllers/**: Gestiona las peticiones de las rutas, llama a los modelos correspondientes y decide qué vista renderizar  
